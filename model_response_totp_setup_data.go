...
// checks if the ResponseTOTPSetupData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseTOTPSetupData{}

// ResponseTOTPSetupData struct for ResponseTOTPSetupData
type ResponseTOTPSetupData struct {
...
type _ResponseTOTPSetupData ResponseTOTPSetupData
...
func (o *ResponseTOTPSetupData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseTOTPSetupData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseTOTPSetupData) MarshalJSON() ([]byte, error) {
...
func (o ResponseTOTPSetupData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseTOTPSetupData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseTOTPSetupData := _ResponseTOTPSetupData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseTOTPSetupData)

	if err != nil {
		return err
	}

	*o = ResponseTOTPSetupData(varResponseTOTPSetupData)

	return err
}

type NullableResponseTOTPSetupData struct {
	value *ResponseTOTPSetupData
	isSet bool
}

func (v NullableResponseTOTPSetupData) Get() *ResponseTOTPSetupData {
	return v.value
}

func (v *NullableResponseTOTPSetupData) Set(val *ResponseTOTPSetupData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseTOTPSetupData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseTOTPSetupData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseTOTPSetupData(val *ResponseTOTPSetupData) *NullableResponseTOTPSetupData {
	return &NullableResponseTOTPSetupData{value: val, isSet: true}
}

func (v NullableResponseTOTPSetupData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseTOTPSetupData) UnmarshalJSON(src []byte) error {
	v.isSet = true
