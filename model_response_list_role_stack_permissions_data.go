...
// checks if the ResponseListRoleStackPermissionsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListRoleStackPermissionsData{}

// ResponseListRoleStackPermissionsData struct for ResponseListRoleStackPermissionsData
type ResponseListRoleStackPermissionsData struct {
...
type _ResponseListRoleStackPermissionsData ResponseListRoleStackPermissionsData
...
func NewResponseListRoleStackPermissionsData(data ListRoleStackPermissionsData, success bool) *ResponseListRoleStackPermissionsData {
	this := ResponseListRoleStackPermissionsData{}
	this.Data = data
...
func (o *ResponseListRoleStackPermissionsData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseListRoleStackPermissionsData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseListRoleStackPermissionsData) MarshalJSON() ([]byte, error) {
...
func (o ResponseListRoleStackPermissionsData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseListRoleStackPermissionsData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseListRoleStackPermissionsData := _ResponseListRoleStackPermissionsData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseListRoleStackPermissionsData)

	if err != nil {
		return err
	}

	*o = ResponseListRoleStackPermissionsData(varResponseListRoleStackPermissionsData)

	return err
}

type NullableResponseListRoleStackPermissionsData struct {
	value *ResponseListRoleStackPermissionsData
	isSet bool
}

func (v NullableResponseListRoleStackPermissionsData) Get() *ResponseListRoleStackPermissionsData {
	return v.value
}

func (v *NullableResponseListRoleStackPermissionsData) Set(val *ResponseListRoleStackPermissionsData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListRoleStackPermissionsData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListRoleStackPermissionsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListRoleStackPermissionsData(val *ResponseListRoleStackPermissionsData) *NullableResponseListRoleStackPermissionsData {
	return &NullableResponseListRoleStackPermissionsData{value: val, isSet: true}
}

func (v NullableResponseListRoleStackPermissionsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListRoleStackPermissionsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
