...
// checks if the ResponseOperationLogStatsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseOperationLogStatsData{}

// ResponseOperationLogStatsData struct for ResponseOperationLogStatsData
type ResponseOperationLogStatsData struct {
...
type _ResponseOperationLogStatsData ResponseOperationLogStatsData
...
func NewResponseOperationLogStatsData(data OperationLogStatsData, success bool) *ResponseOperationLogStatsData {
	this := ResponseOperationLogStatsData{}
	this.Data = data
...
func (o *ResponseOperationLogStatsData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseOperationLogStatsData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseOperationLogStatsData) MarshalJSON() ([]byte, error) {
...
func (o ResponseOperationLogStatsData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseOperationLogStatsData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseOperationLogStatsData := _ResponseOperationLogStatsData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseOperationLogStatsData)

	if err != nil {
		return err
	}

	*o = ResponseOperationLogStatsData(varResponseOperationLogStatsData)

	return err
}

type NullableResponseOperationLogStatsData struct {
	value *ResponseOperationLogStatsData
	isSet bool
}

func (v NullableResponseOperationLogStatsData) Get() *ResponseOperationLogStatsData {
	return v.value
}

func (v *NullableResponseOperationLogStatsData) Set(val *ResponseOperationLogStatsData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseOperationLogStatsData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseOperationLogStatsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseOperationLogStatsData(val *ResponseOperationLogStatsData) *NullableResponseOperationLogStatsData {
	return &NullableResponseOperationLogStatsData{value: val, isSet: true}
}

func (v NullableResponseOperationLogStatsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseOperationLogStatsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
