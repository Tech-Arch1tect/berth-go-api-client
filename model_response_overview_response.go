...
// checks if the ResponseOverviewResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseOverviewResponse{}

// ResponseOverviewResponse struct for ResponseOverviewResponse
type ResponseOverviewResponse struct {
...
type _ResponseOverviewResponse ResponseOverviewResponse
...
func (o *ResponseOverviewResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseOverviewResponse) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseOverviewResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseOverviewResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseOverviewResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseOverviewResponse := _ResponseOverviewResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseOverviewResponse)

	if err != nil {
		return err
	}

	*o = ResponseOverviewResponse(varResponseOverviewResponse)

	return err
}

type NullableResponseOverviewResponse struct {
	value *ResponseOverviewResponse
	isSet bool
}

func (v NullableResponseOverviewResponse) Get() *ResponseOverviewResponse {
	return v.value
}

func (v *NullableResponseOverviewResponse) Set(val *ResponseOverviewResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseOverviewResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseOverviewResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseOverviewResponse(val *ResponseOverviewResponse) *NullableResponseOverviewResponse {
	return &NullableResponseOverviewResponse{value: val, isSet: true}
}

func (v NullableResponseOverviewResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseOverviewResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
