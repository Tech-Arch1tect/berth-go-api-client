...
// checks if the ResponseBackupFileListing type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseBackupFileListing{}

// ResponseBackupFileListing struct for ResponseBackupFileListing
type ResponseBackupFileListing struct {
	Data BackupFileListing `json:"data"`
	Error NullableError `json:"error,omitempty"`
	Meta NullableMeta `json:"meta,omitempty"`
	Success bool `json:"success"`
}

type _ResponseBackupFileListing ResponseBackupFileListing
...
func NewResponseBackupFileListing(data BackupFileListing, success bool) *ResponseBackupFileListing {
	this := ResponseBackupFileListing{}
	this.Data = data
...
func (o *ResponseBackupFileListing) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseBackupFileListing) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseBackupFileListing) MarshalJSON() ([]byte, error) {
...
func (o ResponseBackupFileListing) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseBackupFileListing) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseBackupFileListing := _ResponseBackupFileListing{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseBackupFileListing)

	if err != nil {
		return err
	}

	*o = ResponseBackupFileListing(varResponseBackupFileListing)

	return err
}

type NullableResponseBackupFileListing struct {
	value *ResponseBackupFileListing
	isSet bool
}

func (v NullableResponseBackupFileListing) Get() *ResponseBackupFileListing {
	return v.value
}

func (v *NullableResponseBackupFileListing) Set(val *ResponseBackupFileListing) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseBackupFileListing) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseBackupFileListing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseBackupFileListing(val *ResponseBackupFileListing) *NullableResponseBackupFileListing {
	return &NullableResponseBackupFileListing{value: val, isSet: true}
}

func (v NullableResponseBackupFileListing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseBackupFileListing) UnmarshalJSON(src []byte) error {
	v.isSet = true
