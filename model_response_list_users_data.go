...
// checks if the ResponseListUsersData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListUsersData{}

// ResponseListUsersData struct for ResponseListUsersData
type ResponseListUsersData struct {
...
type _ResponseListUsersData ResponseListUsersData
...
func (o *ResponseListUsersData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseListUsersData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseListUsersData) MarshalJSON() ([]byte, error) {
...
func (o ResponseListUsersData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseListUsersData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseListUsersData := _ResponseListUsersData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseListUsersData)

	if err != nil {
		return err
	}

	*o = ResponseListUsersData(varResponseListUsersData)

	return err
}

type NullableResponseListUsersData struct {
	value *ResponseListUsersData
	isSet bool
}

func (v NullableResponseListUsersData) Get() *ResponseListUsersData {
	return v.value
}

func (v *NullableResponseListUsersData) Set(val *ResponseListUsersData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListUsersData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListUsersData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListUsersData(val *ResponseListUsersData) *NullableResponseListUsersData {
	return &NullableResponseListUsersData{value: val, isSet: true}
}

func (v NullableResponseListUsersData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListUsersData) UnmarshalJSON(src []byte) error {
	v.isSet = true
