...
// checks if the ResponseSessionMessageData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseSessionMessageData{}

// ResponseSessionMessageData struct for ResponseSessionMessageData
type ResponseSessionMessageData struct {
...
type _ResponseSessionMessageData ResponseSessionMessageData
...
func NewResponseSessionMessageData(data SessionMessageData, success bool) *ResponseSessionMessageData {
	this := ResponseSessionMessageData{}
	this.Data = data
...
func (o *ResponseSessionMessageData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseSessionMessageData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseSessionMessageData) MarshalJSON() ([]byte, error) {
...
func (o ResponseSessionMessageData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseSessionMessageData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseSessionMessageData := _ResponseSessionMessageData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseSessionMessageData)

	if err != nil {
		return err
	}

	*o = ResponseSessionMessageData(varResponseSessionMessageData)

	return err
}

type NullableResponseSessionMessageData struct {
	value *ResponseSessionMessageData
	isSet bool
}

func (v NullableResponseSessionMessageData) Get() *ResponseSessionMessageData {
	return v.value
}

func (v *NullableResponseSessionMessageData) Set(val *ResponseSessionMessageData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseSessionMessageData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseSessionMessageData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseSessionMessageData(val *ResponseSessionMessageData) *NullableResponseSessionMessageData {
	return &NullableResponseSessionMessageData{value: val, isSet: true}
}

func (v NullableResponseSessionMessageData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseSessionMessageData) UnmarshalJSON(src []byte) error {
	v.isSet = true
