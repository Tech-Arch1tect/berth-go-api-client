...
// checks if the ResponseBucketResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseBucketResponse{}

// ResponseBucketResponse struct for ResponseBucketResponse
type ResponseBucketResponse struct {
...
type _ResponseBucketResponse ResponseBucketResponse
...
func (o *ResponseBucketResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseBucketResponse) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseBucketResponse) MarshalJSON() ([]byte, error) {
...
func (o ResponseBucketResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseBucketResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseBucketResponse := _ResponseBucketResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseBucketResponse)

	if err != nil {
		return err
	}

	*o = ResponseBucketResponse(varResponseBucketResponse)

	return err
}

type NullableResponseBucketResponse struct {
	value *ResponseBucketResponse
	isSet bool
}

func (v NullableResponseBucketResponse) Get() *ResponseBucketResponse {
	return v.value
}

func (v *NullableResponseBucketResponse) Set(val *ResponseBucketResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseBucketResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseBucketResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseBucketResponse(val *ResponseBucketResponse) *NullableResponseBucketResponse {
	return &NullableResponseBucketResponse{value: val, isSet: true}
}

func (v NullableResponseBucketResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseBucketResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
