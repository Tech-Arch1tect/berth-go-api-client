...
// checks if the ResponseHistoryState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseHistoryState{}

// ResponseHistoryState struct for ResponseHistoryState
type ResponseHistoryState struct {
	Data HistoryState `json:"data"`
	Error NullableError `json:"error,omitempty"`
	Meta NullableMeta `json:"meta,omitempty"`
	Success bool `json:"success"`
}

type _ResponseHistoryState ResponseHistoryState
...
func (o *ResponseHistoryState) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseHistoryState) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseHistoryState) MarshalJSON() ([]byte, error) {
...
func (o ResponseHistoryState) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseHistoryState) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseHistoryState := _ResponseHistoryState{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseHistoryState)

	if err != nil {
		return err
	}

	*o = ResponseHistoryState(varResponseHistoryState)

	return err
}

type NullableResponseHistoryState struct {
	value *ResponseHistoryState
	isSet bool
}

func (v NullableResponseHistoryState) Get() *ResponseHistoryState {
	return v.value
}

func (v *NullableResponseHistoryState) Set(val *ResponseHistoryState) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseHistoryState) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseHistoryState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseHistoryState(val *ResponseHistoryState) *NullableResponseHistoryState {
	return &NullableResponseHistoryState{value: val, isSet: true}
}

func (v NullableResponseHistoryState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseHistoryState) UnmarshalJSON(src []byte) error {
	v.isSet = true
