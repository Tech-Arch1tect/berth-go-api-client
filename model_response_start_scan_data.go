...
// checks if the ResponseStartScanData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseStartScanData{}

// ResponseStartScanData struct for ResponseStartScanData
type ResponseStartScanData struct {
...
type _ResponseStartScanData ResponseStartScanData
...
func (o *ResponseStartScanData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseStartScanData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseStartScanData) MarshalJSON() ([]byte, error) {
...
func (o ResponseStartScanData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseStartScanData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseStartScanData := _ResponseStartScanData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseStartScanData)

	if err != nil {
		return err
	}

	*o = ResponseStartScanData(varResponseStartScanData)

	return err
}

type NullableResponseStartScanData struct {
	value *ResponseStartScanData
	isSet bool
}

func (v NullableResponseStartScanData) Get() *ResponseStartScanData {
	return v.value
}

func (v *NullableResponseStartScanData) Set(val *ResponseStartScanData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseStartScanData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseStartScanData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseStartScanData(val *ResponseStartScanData) *NullableResponseStartScanData {
	return &NullableResponseStartScanData{value: val, isSet: true}
}

func (v NullableResponseStartScanData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseStartScanData) UnmarshalJSON(src []byte) error {
	v.isSet = true
