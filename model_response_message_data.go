...
// checks if the ResponseMessageData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseMessageData{}

// ResponseMessageData struct for ResponseMessageData
...
type _ResponseMessageData ResponseMessageData
...
func (o *ResponseMessageData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseMessageData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseMessageData) MarshalJSON() ([]byte, error) {
...
func (o ResponseMessageData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseMessageData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseMessageData := _ResponseMessageData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseMessageData)

	if err != nil {
		return err
	}

	*o = ResponseMessageData(varResponseMessageData)

	return err
}

type NullableResponseMessageData struct {
	value *ResponseMessageData
	isSet bool
}

func (v NullableResponseMessageData) Get() *ResponseMessageData {
	return v.value
}

func (v *NullableResponseMessageData) Set(val *ResponseMessageData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseMessageData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseMessageData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseMessageData(val *ResponseMessageData) *NullableResponseMessageData {
	return &NullableResponseMessageData{value: val, isSet: true}
}

func (v NullableResponseMessageData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseMessageData) UnmarshalJSON(src []byte) error {
	v.isSet = true
