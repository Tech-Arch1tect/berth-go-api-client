...
// checks if the ResponseDeleteResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseDeleteResult{}

// ResponseDeleteResult struct for ResponseDeleteResult
...
type _ResponseDeleteResult ResponseDeleteResult
...
func (o *ResponseDeleteResult) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseDeleteResult) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseDeleteResult) MarshalJSON() ([]byte, error) {
...
func (o ResponseDeleteResult) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseDeleteResult) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseDeleteResult := _ResponseDeleteResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseDeleteResult)

	if err != nil {
		return err
	}

	*o = ResponseDeleteResult(varResponseDeleteResult)

	return err
}

type NullableResponseDeleteResult struct {
	value *ResponseDeleteResult
	isSet bool
}

func (v NullableResponseDeleteResult) Get() *ResponseDeleteResult {
	return v.value
}

func (v *NullableResponseDeleteResult) Set(val *ResponseDeleteResult) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseDeleteResult) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseDeleteResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseDeleteResult(val *ResponseDeleteResult) *NullableResponseDeleteResult {
	return &NullableResponseDeleteResult{value: val, isSet: true}
}

func (v NullableResponseDeleteResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseDeleteResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
