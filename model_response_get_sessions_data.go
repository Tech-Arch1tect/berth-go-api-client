...
// checks if the ResponseGetSessionsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseGetSessionsData{}

// ResponseGetSessionsData struct for ResponseGetSessionsData
type ResponseGetSessionsData struct {
...
type _ResponseGetSessionsData ResponseGetSessionsData
...
func (o *ResponseGetSessionsData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseGetSessionsData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseGetSessionsData) MarshalJSON() ([]byte, error) {
...
func (o ResponseGetSessionsData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseGetSessionsData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseGetSessionsData := _ResponseGetSessionsData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseGetSessionsData)

	if err != nil {
		return err
	}

	*o = ResponseGetSessionsData(varResponseGetSessionsData)

	return err
}

type NullableResponseGetSessionsData struct {
	value *ResponseGetSessionsData
	isSet bool
}

func (v NullableResponseGetSessionsData) Get() *ResponseGetSessionsData {
	return v.value
}

func (v *NullableResponseGetSessionsData) Set(val *ResponseGetSessionsData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseGetSessionsData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseGetSessionsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseGetSessionsData(val *ResponseGetSessionsData) *NullableResponseGetSessionsData {
	return &NullableResponseGetSessionsData{value: val, isSet: true}
}

func (v NullableResponseGetSessionsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseGetSessionsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
