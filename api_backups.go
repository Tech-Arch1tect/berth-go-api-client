...
type ApiApiV1AdminServersIdBackupStorageAbandonPostRequest struct {
	ctx context.Context
	ApiService *BackupsAPIService
	id int32
}

func (r ApiApiV1AdminServersIdBackupStorageAbandonPostRequest) Execute() (*ResponseAbandonBackupStorageResult, *http.Response, error) {
	return r.ApiService.ApiV1AdminServersIdBackupStorageAbandonPostExecute(r)
}

/*
ApiV1AdminServersIdBackupStorageAbandonPost Abandon a server's backup history
...
Removes the agent-local backup history used by Berth without reading or deleting repository data. Returns exact full or partial results; an HTTP 200 does not mean every history entry was removed. The request body must contain zero bytes. Requires admin server write access.
 ...
 @param id Server ID
 @return ApiApiV1AdminServersIdBackupStorageAbandonPostRequest
*/
func (a *BackupsAPIService) ApiV1AdminServersIdBackupStorageAbandonPost(ctx context.Context, id int32) ApiApiV1AdminServersIdBackupStorageAbandonPostRequest {
	return ApiApiV1AdminServersIdBackupStorageAbandonPostRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
//  @return ResponseAbandonBackupStorageResult
func (a *BackupsAPIService) ApiV1AdminServersIdBackupStorageAbandonPostExecute(r ApiApiV1AdminServersIdBackupStorageAbandonPostRequest) (*ResponseAbandonBackupStorageResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ResponseAbandonBackupStorageResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupsAPIService.ApiV1AdminServersIdBackupStorageAbandonPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/admin/servers/{id}/backup-storage/abandon"
...
type ApiApiV1AdminServersIdBackupStorageDeleteAllPostRequest struct {
	ctx context.Context
	ApiService *BackupsAPIService
	id int32
}

func (r ApiApiV1AdminServersIdBackupStorageDeleteAllPostRequest) Execute() (*ResponseDeleteAllResult, *http.Response, error) {
	return r.ApiService.ApiV1AdminServersIdBackupStorageDeleteAllPostExecute(r)
}

/*
ApiV1AdminServersIdBackupStorageDeleteAllPost Delete every backup for a server
...
Attempts every stack repository using the server's stored backup password and storage assignment. Returns exact full or partial results; an HTTP 200 does not mean every backup was deleted. Requires admin server write access.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id Server ID
 @return ApiApiV1AdminServersIdBackupStorageDeleteAllPostRequest
*/
func (a *BackupsAPIService) ApiV1AdminServersIdBackupStorageDeleteAllPost(ctx context.Context, id int32) ApiApiV1AdminServersIdBackupStorageDeleteAllPostRequest {
	return ApiApiV1AdminServersIdBackupStorageDeleteAllPostRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
// Execute executes the request
//  @return ResponseDeleteAllResult
func (a *BackupsAPIService) ApiV1AdminServersIdBackupStorageDeleteAllPostExecute(r ApiApiV1AdminServersIdBackupStorageDeleteAllPostRequest) (*ResponseDeleteAllResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ResponseDeleteAllResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupsAPIService.ApiV1AdminServersIdBackupStorageDeleteAllPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/admin/servers/{id}/backup-storage/delete-all"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiApiV1AdminServersIdBackupStorageGetRequest struct {
	ctx context.Context
	ApiService *BackupsAPIService
	id int32
}

func (r ApiApiV1AdminServersIdBackupStorageGetRequest) Execute() (*ResponseHistoryState, *http.Response, error) {
	return r.ApiService.ApiV1AdminServersIdBackupStorageGetExecute(r)
}

/*
ApiV1AdminServersIdBackupStorageGet Read a server's backup storage history status

Returns exact agent-local backup history counts for storage lifecycle decisions. Requires admin server read access.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param id Server ID
 @return ApiApiV1AdminServersIdBackupStorageGetRequest
*/
func (a *BackupsAPIService) ApiV1AdminServersIdBackupStorageGet(ctx context.Context, id int32) ApiApiV1AdminServersIdBackupStorageGetRequest {
	return ApiApiV1AdminServersIdBackupStorageGetRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *BackupsAPIService) ApiV1AdminServersIdBackupStorageGetExecute(r ApiApiV1AdminServersIdBackupStorageGetRequest) (*ResponseHistoryState, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ResponseHistoryState
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupsAPIService.ApiV1AdminServersIdBackupStorageGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/admin/servers/{id}/backup-storage"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
type ApiApiV1BackupsGetRequest struct {
	ctx context.Context
	ApiService *BackupsAPIService
}

func (r ApiApiV1BackupsGetRequest) Execute() (*ResponseOverviewResponse, *http.Response, error) {
	return r.ApiService.ApiV1BackupsGetExecute(r)
}

/*
ApiV1BackupsGet List backup coverage across every reachable server
...
Returns each server the caller can see, with the stacks on it that the caller may read backups for. Includes stacks that have never been backed up, and stacks whose directory no longer exists but whose backups remain
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiV1BackupsGetRequest
*/
func (a *BackupsAPIService) ApiV1BackupsGet(ctx context.Context) ApiApiV1BackupsGetRequest {
	return ApiApiV1BackupsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ResponseOverviewResponse
func (a *BackupsAPIService) ApiV1BackupsGetExecute(r ApiApiV1BackupsGetRequest) (*ResponseOverviewResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ResponseOverviewResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupsAPIService.ApiV1BackupsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiApiV1ServersServeridStacksStacknameBackupsRebuildPostRequest struct {
	ctx context.Context
	ApiService *BackupsAPIService
	serverid int32
	stackname string
...
func (r ApiApiV1ServersServeridStacksStacknameBackupsRebuildPostRequest) Execute() (*ResponseRebuildResult, *http.Response, error) {
	return r.ApiService.ApiV1ServersServeridStacksStacknameBackupsRebuildPostExecute(r)
}

/*
ApiV1ServersServeridStacksStacknameBackupsRebuildPost Rebuild a stack's backup history from its repository
...
Reads the stack's restic repository on the agent and adds any backup runs that are missing from the agent's metadata; existing metadata is never overwritten. Requires backups to be enabled with an encryption password on the server
 ...
 @param serverid Server ID
 @param stackname Stack name
 @return ApiApiV1ServersServeridStacksStacknameBackupsRebuildPostRequest
*/
func (a *BackupsAPIService) ApiV1ServersServeridStacksStacknameBackupsRebuildPost(ctx context.Context, serverid int32, stackname string) ApiApiV1ServersServeridStacksStacknameBackupsRebuildPostRequest {
	return ApiApiV1ServersServeridStacksStacknameBackupsRebuildPostRequest{
		ApiService: a,
		ctx: ctx,
		serverid: serverid,
...
// Execute executes the request
//  @return ResponseRebuildResult
func (a *BackupsAPIService) ApiV1ServersServeridStacksStacknameBackupsRebuildPostExecute(r ApiApiV1ServersServeridStacksStacknameBackupsRebuildPostRequest) (*ResponseRebuildResult, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ResponseRebuildResult
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "BackupsAPIService.ApiV1ServersServeridStacksStacknameBackupsRebuildPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/servers/{serverid}/stacks/{stackname}/backups/rebuild"
	localVarPath = strings.Replace(localVarPath, "{"+"serverid"+"}", url.PathEscape(parameterValueToString(r.serverid, "serverid")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"stackname"+"}", url.PathEscape(parameterValueToString(r.stackname, "stackname")), -1)
