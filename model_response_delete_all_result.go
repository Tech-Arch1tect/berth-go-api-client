...
// checks if the ResponseDeleteAllResult type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseDeleteAllResult{}

// ResponseDeleteAllResult struct for ResponseDeleteAllResult
type ResponseDeleteAllResult struct {
	Data DeleteAllResult `json:"data"`
	Error NullableError `json:"error,omitempty"`
	Meta NullableMeta `json:"meta,omitempty"`
	Success bool `json:"success"`
}

type _ResponseDeleteAllResult ResponseDeleteAllResult
...
func (o *ResponseDeleteAllResult) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseDeleteAllResult) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseDeleteAllResult) MarshalJSON() ([]byte, error) {
...
func (o ResponseDeleteAllResult) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseDeleteAllResult) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseDeleteAllResult := _ResponseDeleteAllResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseDeleteAllResult)

	if err != nil {
		return err
	}

	*o = ResponseDeleteAllResult(varResponseDeleteAllResult)

	return err
}

type NullableResponseDeleteAllResult struct {
	value *ResponseDeleteAllResult
	isSet bool
}

func (v NullableResponseDeleteAllResult) Get() *ResponseDeleteAllResult {
	return v.value
}

func (v *NullableResponseDeleteAllResult) Set(val *ResponseDeleteAllResult) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseDeleteAllResult) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseDeleteAllResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseDeleteAllResult(val *ResponseDeleteAllResult) *NullableResponseDeleteAllResult {
	return &NullableResponseDeleteAllResult{value: val, isSet: true}
}

func (v NullableResponseDeleteAllResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseDeleteAllResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
