...
> ResponseListResponse ApiV1ServersServeridStacksStacknameBackupsGet(ctx, serverid, stackname).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.BackupsAPI.ApiV1ServersServeridStacksStacknameBackupsGet(context.Background(), serverid, stackname).Execute()
	if err != nil {
