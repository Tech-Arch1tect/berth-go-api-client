...
type ApiApiV1ImageUpdatesGetRequest struct {
	ctx context.Context
...
/*
ApiV1ImageUpdatesGet List available image updates

Returns all container images with available updates across servers the user can access

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiApiV1ImageUpdatesGetRequest
*/
func (a *ImageUpdatesAPIService) ApiV1ImageUpdatesGet(ctx context.Context) ApiApiV1ImageUpdatesGetRequest {
	return ApiApiV1ImageUpdatesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ImageUpdatesAPIService) ApiV1ImageUpdatesGetExecute(r ApiApiV1ImageUpdatesGetRequest) (*ImageUpdatesResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/image-updates"
...
type ApiApiV1ServersServeridImageUpdatesGetRequest struct {
	ctx context.Context
	ApiService *ImageUpdatesAPIService
	serverid int32
}
...
/*
ApiV1ServersServeridImageUpdatesGet List server image updates

Returns container images with available updates for a specific server

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param serverid Server ID
 @return ApiApiV1ServersServeridImageUpdatesGetRequest
*/
func (a *ImageUpdatesAPIService) ApiV1ServersServeridImageUpdatesGet(ctx context.Context, serverid int32) ApiApiV1ServersServeridImageUpdatesGetRequest {
	return ApiApiV1ServersServeridImageUpdatesGetRequest{
		ApiService: a,
		ctx: ctx,
		serverid: serverid,
...
func (a *ImageUpdatesAPIService) ApiV1ServersServeridImageUpdatesGetExecute(r ApiApiV1ServersServeridImageUpdatesGetRequest) (*ImageUpdatesResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/servers/{serverid}/image-updates"
