...
// checks if the ResponseImageUpdatesData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseImageUpdatesData{}

// ResponseImageUpdatesData struct for ResponseImageUpdatesData
type ResponseImageUpdatesData struct {
	Data ImageUpdatesData `json:"data"`
	Error NullableError `json:"error,omitempty"`
	Meta NullableMeta `json:"meta,omitempty"`
	Success bool `json:"success"`
}

type _ResponseImageUpdatesData ResponseImageUpdatesData
...
func (o *ResponseImageUpdatesData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseImageUpdatesData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseImageUpdatesData) MarshalJSON() ([]byte, error) {
...
func (o ResponseImageUpdatesData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseImageUpdatesData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseImageUpdatesData := _ResponseImageUpdatesData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseImageUpdatesData)

	if err != nil {
		return err
	}

	*o = ResponseImageUpdatesData(varResponseImageUpdatesData)

	return err
}

type NullableResponseImageUpdatesData struct {
	value *ResponseImageUpdatesData
	isSet bool
}

func (v NullableResponseImageUpdatesData) Get() *ResponseImageUpdatesData {
	return v.value
}

func (v *NullableResponseImageUpdatesData) Set(val *ResponseImageUpdatesData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseImageUpdatesData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseImageUpdatesData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseImageUpdatesData(val *ResponseImageUpdatesData) *NullableResponseImageUpdatesData {
	return &NullableResponseImageUpdatesData{value: val, isSet: true}
}

func (v NullableResponseImageUpdatesData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseImageUpdatesData) UnmarshalJSON(src []byte) error {
	v.isSet = true
