...
// checks if the ResponseServerStatisticsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseServerStatisticsData{}

// ResponseServerStatisticsData struct for ResponseServerStatisticsData
type ResponseServerStatisticsData struct {
	Data ServerStatisticsData `json:"data"`
	Error NullableError `json:"error,omitempty"`
	Meta NullableMeta `json:"meta,omitempty"`
	Success bool `json:"success"`
}

type _ResponseServerStatisticsData ResponseServerStatisticsData
...
func NewResponseServerStatisticsData(data ServerStatisticsData, success bool) *ResponseServerStatisticsData {
	this := ResponseServerStatisticsData{}
	this.Data = data
...
func (o *ResponseServerStatisticsData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseServerStatisticsData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseServerStatisticsData) MarshalJSON() ([]byte, error) {
...
func (o ResponseServerStatisticsData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseServerStatisticsData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseServerStatisticsData := _ResponseServerStatisticsData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseServerStatisticsData)

	if err != nil {
		return err
	}

	*o = ResponseServerStatisticsData(varResponseServerStatisticsData)

	return err
}

type NullableResponseServerStatisticsData struct {
	value *ResponseServerStatisticsData
	isSet bool
}

func (v NullableResponseServerStatisticsData) Get() *ResponseServerStatisticsData {
	return v.value
}

func (v *NullableResponseServerStatisticsData) Set(val *ResponseServerStatisticsData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseServerStatisticsData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseServerStatisticsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseServerStatisticsData(val *ResponseServerStatisticsData) *NullableResponseServerStatisticsData {
	return &NullableResponseServerStatisticsData{value: val, isSet: true}
}

func (v NullableResponseServerStatisticsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseServerStatisticsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
