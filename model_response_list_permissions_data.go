...
// checks if the ResponseListPermissionsData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListPermissionsData{}

// ResponseListPermissionsData struct for ResponseListPermissionsData
type ResponseListPermissionsData struct {
...
type _ResponseListPermissionsData ResponseListPermissionsData
...
func NewResponseListPermissionsData(data ListPermissionsData, success bool) *ResponseListPermissionsData {
	this := ResponseListPermissionsData{}
	this.Data = data
...
func (o *ResponseListPermissionsData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseListPermissionsData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseListPermissionsData) MarshalJSON() ([]byte, error) {
...
func (o ResponseListPermissionsData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseListPermissionsData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseListPermissionsData := _ResponseListPermissionsData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseListPermissionsData)

	if err != nil {
		return err
	}

	*o = ResponseListPermissionsData(varResponseListPermissionsData)

	return err
}

type NullableResponseListPermissionsData struct {
	value *ResponseListPermissionsData
	isSet bool
}

func (v NullableResponseListPermissionsData) Get() *ResponseListPermissionsData {
	return v.value
}

func (v *NullableResponseListPermissionsData) Set(val *ResponseListPermissionsData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListPermissionsData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListPermissionsData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListPermissionsData(val *ResponseListPermissionsData) *NullableResponseListPermissionsData {
	return &NullableResponseListPermissionsData{value: val, isSet: true}
}

func (v NullableResponseListPermissionsData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListPermissionsData) UnmarshalJSON(src []byte) error {
	v.isSet = true
