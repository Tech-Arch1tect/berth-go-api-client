...
func (o *ImportData) UnmarshalJSON(data []byte) (err error) {
	...
	varImportData := _ImportData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varImportData)

	if err != nil {
		return err
	}

	*o = ImportData(varImportData)
