...
// checks if the ResponseImportData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseImportData{}

// ResponseImportData struct for ResponseImportData
type ResponseImportData struct {
...
type _ResponseImportData ResponseImportData
...
func (o *ResponseImportData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseImportData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseImportData) MarshalJSON() ([]byte, error) {
...
func (o ResponseImportData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseImportData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseImportData := _ResponseImportData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseImportData)

	if err != nil {
		return err
	}

	*o = ResponseImportData(varResponseImportData)

	return err
}

type NullableResponseImportData struct {
	value *ResponseImportData
	isSet bool
}

func (v NullableResponseImportData) Get() *ResponseImportData {
	return v.value
}

func (v *NullableResponseImportData) Set(val *ResponseImportData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseImportData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseImportData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseImportData(val *ResponseImportData) *NullableResponseImportData {
	return &NullableResponseImportData{value: val, isSet: true}
}

func (v NullableResponseImportData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseImportData) UnmarshalJSON(src []byte) error {
	v.isSet = true
