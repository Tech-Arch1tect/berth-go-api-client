...
------------ | ------------- | ------------- | -------------
*AdminAPI* | [**ApiV1AdminAgentAuthorityClientCertificatePost**](docs/AdminAPI.md#apiv1adminagentauthorityclientcertificatepost) | **Post** /api/v1/admin/agent-authority/client-certificate | Reissue the client certificate
*AdminAPI* | [**ApiV1AdminAgentAuthorityGet**](docs/AdminAPI.md#apiv1adminagentauthorityget) | **Get** /api/v1/admin/agent-authority | Get agent certificate authority status
*AdminAPI* | [**ApiV1AdminAgentAuthorityRotatePost**](docs/AdminAPI.md#apiv1adminagentauthorityrotatepost) | **Post** /api/v1/admin/agent-authority/rotate | Rotate the certificate authority
...
*AdminAPI* | [**ApiV1AdminServersIdAgentBundlePost**](docs/AdminAPI.md#apiv1adminserversidagentbundlepost) | **Post** /api/v1/admin/servers/{id}/agent-bundle | Issue agent certificate bundle
...
*AdminAPI* | [**ApiV1AdminServersIdGet**](docs/AdminAPI.md#apiv1adminserversidget) | **Get** /api/v1/admin/servers/{id} | Get a server
...
*AuthAPI* | [**ApiV1AuthPasswordResetConfirmPost**](docs/AuthAPI.md#apiv1authpasswordresetconfirmpost) | **Post** /api/v1/auth/password-reset/confirm | Complete a password reset
*AuthAPI* | [**ApiV1AuthPasswordResetPost**](docs/AuthAPI.md#apiv1authpasswordresetpost) | **Post** /api/v1/auth/password-reset | Request a password reset email
...
*BackupsAPI* | [**ApiV1ServersServeridStacksStacknameBackupsRebuildPost**](docs/BackupsAPI.md#apiv1serversserveridstacksstacknamebackupsrebuildpost) | **Post** /api/v1/servers/{serverid}/stacks/{stackname}/backups/rebuild | Rebuild a stack&#39;s backup history from its repository
...
*OperationsAPI* | [**ApiV1ServersServeridStacksStacknameOperationsPost**](docs/OperationsAPI.md#apiv1serversserveridstacksstacknameoperationspost) | **Post** /api/v1/servers/{serverid}/stacks/{stackname}/operations | Start a stack operation
...
*S3BucketsAPI* | [**ApiV1AdminS3BucketsGet**](docs/S3BucketsAPI.md#apiv1admins3bucketsget) | **Get** /api/v1/admin/s3-buckets | List S3 bucket configurations
*S3BucketsAPI* | [**ApiV1AdminS3BucketsIdDelete**](docs/S3BucketsAPI.md#apiv1admins3bucketsiddelete) | **Delete** /api/v1/admin/s3-buckets/{id} | Delete an S3 bucket configuration
*S3BucketsAPI* | [**ApiV1AdminS3BucketsIdGet**](docs/S3BucketsAPI.md#apiv1admins3bucketsidget) | **Get** /api/v1/admin/s3-buckets/{id} | Get an S3 bucket configuration
*S3BucketsAPI* | [**ApiV1AdminS3BucketsIdPut**](docs/S3BucketsAPI.md#apiv1admins3bucketsidput) | **Put** /api/v1/admin/s3-buckets/{id} | Update an S3 bucket configuration
*S3BucketsAPI* | [**ApiV1AdminS3BucketsPost**](docs/S3BucketsAPI.md#apiv1admins3bucketspost) | **Post** /api/v1/admin/s3-buckets | Create an S3 bucket configuration
*ServersAPI* | [**ApiV1ServersGet**](docs/ServersAPI.md#apiv1serversget) | **Get** /api/v1/servers | List accessible servers
*ServersAPI* | [**ApiV1ServersServeridGet**](docs/ServersAPI.md#apiv1serversserveridget) | **Get** /api/v1/servers/{serverid} | Get server
...
*SessionsAPI* | [**ApiV1SessionsGet**](docs/SessionsAPI.md#apiv1sessionsget) | **Get** /api/v1/sessions | List user sessions
...
## Documentation For Models
 ...
 - [AdminUpdateServerData](docs/AdminUpdateServerData.md)
 - [AgentAuthorityData](docs/AgentAuthorityData.md)
 - [AgentAuthorityStatus](docs/AgentAuthorityStatus.md)
 ...
 - [AuthMessageData](docs/AuthMessageData.md)
 ...
 - [AuthResendVerificationRequest](docs/AuthResendVerificationRequest.md)
 ...
 - [ImageUpdatesData](docs/ImageUpdatesData.md)
 ...
 - [ListUsersData](docs/ListUsersData.md)
 ...
 - [MessageData3](docs/MessageData3.md)
 - [Meta](docs/Meta.md)
 ...
 - [RebuildResult](docs/RebuildResult.md)
 ...
 - [ResponseAgentAuthorityData](docs/ResponseAgentAuthorityData.md)
 - [ResponseAuthLoginData](docs/ResponseAuthLoginData.md)
 - [ResponseAuthLogoutData](docs/ResponseAuthLogoutData.md)
 ...
 - [ResponseBucketResponse](docs/ResponseBucketResponse.md)
 - [ResponseBucketResponse2](docs/ResponseBucketResponse2.md)
 ...
 - [ResponseEmpty](docs/ResponseEmpty.md)
 - [ResponseFileContent](docs/ResponseFileContent.md)
 - [ResponseFileMessageData](docs/ResponseFileMessageData.md)
 - [ResponseGetCredentialData](docs/ResponseGetCredentialData.md)
 - [ResponseGetLatestScanData](docs/ResponseGetLatestScanData.md)
 - [ResponseGetScanData](docs/ResponseGetScanData.md)
 - [ResponseGetScanSummaryData](docs/ResponseGetScanSummaryData.md)
 - [ResponseGetScanTrendData](docs/ResponseGetScanTrendData.md)
 - [ResponseGetScansHistoryData](docs/ResponseGetScansHistoryData.md)
 - [ResponseGetServerData](docs/ResponseGetServerData.md)
 - [ResponseGetSessionsData](docs/ResponseGetSessionsData.md)
 - [ResponseGetUserRolesData](docs/ResponseGetUserRolesData.md)
 - [ResponseHistoryState](docs/ResponseHistoryState.md)
 - [ResponseImageUpdatesData](docs/ResponseImageUpdatesData.md)
 ...
 - [ResponseListStacksData](docs/ResponseListStacksData.md)
 - [ResponseListUsersData](docs/ResponseListUsersData.md)
 - [ResponseLogsData](docs/ResponseLogsData.md)
 - [ResponseMaintenanceInfo](docs/ResponseMaintenanceInfo.md)
 - [ResponseMessageData](docs/ResponseMessageData.md)
 - [ResponseMessageData2](docs/ResponseMessageData2.md)
 - [ResponseMessageData3](docs/ResponseMessageData3.md)
 - [ResponseOperationLogDetailData](docs/ResponseOperationLogDetailData.md)
 ...
 - [ResponseRebuildResult](docs/ResponseRebuildResult.md)
 ...
 - [ResponseServerStatisticsData](docs/ResponseServerStatisticsData.md)
 - [ResponseSessionMessageData](docs/ResponseSessionMessageData.md)
 - [ResponseStackDetails](docs/ResponseStackDetails.md)
 - [ResponseStackEnvironmentData](docs/ResponseStackEnvironmentData.md)
 - [ResponseStackImagesData](docs/ResponseStackImagesData.md)
 - [ResponseStackNetworksData](docs/ResponseStackNetworksData.md)
 - [ResponseStackPermissionsData](docs/ResponseStackPermissionsData.md)
 - [ResponseStackStats](docs/ResponseStackStats.md)
 - [ResponseStackVolumesData](docs/ResponseStackVolumesData.md)
 - [ResponseStartScanData](docs/ResponseStartScanData.md)
 - [ResponseStatsResponseData](docs/ResponseStatsResponseData.md)
 - [ResponseTOTPMessageData](docs/ResponseTOTPMessageData.md)
 - [ResponseTOTPSetupData](docs/ResponseTOTPSetupData.md)
 - [ResponseTOTPStatusData](docs/ResponseTOTPStatusData.md)
 - [ResponseUpdateComposeResponse](docs/ResponseUpdateComposeResponse.md)
 - [ResponseUserIdentity](docs/ResponseUserIdentity.md)
 - [ResponseUserInfo](docs/ResponseUserInfo.md)
 - [ResponseVersionData](docs/ResponseVersionData.md)
