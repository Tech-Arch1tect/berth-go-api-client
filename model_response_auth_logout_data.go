...
// checks if the ResponseAuthLogoutData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseAuthLogoutData{}

// ResponseAuthLogoutData struct for ResponseAuthLogoutData
type ResponseAuthLogoutData struct {
...
type _ResponseAuthLogoutData ResponseAuthLogoutData
...
func (o *ResponseAuthLogoutData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseAuthLogoutData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseAuthLogoutData) MarshalJSON() ([]byte, error) {
...
func (o ResponseAuthLogoutData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseAuthLogoutData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseAuthLogoutData := _ResponseAuthLogoutData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseAuthLogoutData)

	if err != nil {
		return err
	}

	*o = ResponseAuthLogoutData(varResponseAuthLogoutData)

	return err
}

type NullableResponseAuthLogoutData struct {
	value *ResponseAuthLogoutData
	isSet bool
}

func (v NullableResponseAuthLogoutData) Get() *ResponseAuthLogoutData {
	return v.value
}

func (v *NullableResponseAuthLogoutData) Set(val *ResponseAuthLogoutData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseAuthLogoutData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseAuthLogoutData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseAuthLogoutData(val *ResponseAuthLogoutData) *NullableResponseAuthLogoutData {
	return &NullableResponseAuthLogoutData{value: val, isSet: true}
}

func (v NullableResponseAuthLogoutData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseAuthLogoutData) UnmarshalJSON(src []byte) error {
	v.isSet = true
