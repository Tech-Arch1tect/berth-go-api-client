...
// checks if the ResponseDirectoryListing type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseDirectoryListing{}

// ResponseDirectoryListing struct for ResponseDirectoryListing
type ResponseDirectoryListing struct {
...
type _ResponseDirectoryListing ResponseDirectoryListing
...
func (o *ResponseDirectoryListing) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseDirectoryListing) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseDirectoryListing) MarshalJSON() ([]byte, error) {
...
func (o ResponseDirectoryListing) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseDirectoryListing) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseDirectoryListing := _ResponseDirectoryListing{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseDirectoryListing)

	if err != nil {
		return err
	}

	*o = ResponseDirectoryListing(varResponseDirectoryListing)

	return err
}

type NullableResponseDirectoryListing struct {
	value *ResponseDirectoryListing
	isSet bool
}

func (v NullableResponseDirectoryListing) Get() *ResponseDirectoryListing {
	return v.value
}

func (v *NullableResponseDirectoryListing) Set(val *ResponseDirectoryListing) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseDirectoryListing) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseDirectoryListing) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseDirectoryListing(val *ResponseDirectoryListing) *NullableResponseDirectoryListing {
	return &NullableResponseDirectoryListing{value: val, isSet: true}
}

func (v NullableResponseDirectoryListing) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseDirectoryListing) UnmarshalJSON(src []byte) error {
	v.isSet = true
