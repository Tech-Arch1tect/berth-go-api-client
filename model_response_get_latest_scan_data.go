...
// checks if the ResponseGetLatestScanData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseGetLatestScanData{}

// ResponseGetLatestScanData struct for ResponseGetLatestScanData
type ResponseGetLatestScanData struct {
...
type _ResponseGetLatestScanData ResponseGetLatestScanData
...
func NewResponseGetLatestScanData(data GetLatestScanData, success bool) *ResponseGetLatestScanData {
	this := ResponseGetLatestScanData{}
	this.Data = data
...
func (o *ResponseGetLatestScanData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseGetLatestScanData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseGetLatestScanData) MarshalJSON() ([]byte, error) {
...
func (o ResponseGetLatestScanData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseGetLatestScanData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseGetLatestScanData := _ResponseGetLatestScanData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseGetLatestScanData)

	if err != nil {
		return err
	}

	*o = ResponseGetLatestScanData(varResponseGetLatestScanData)

	return err
}

type NullableResponseGetLatestScanData struct {
	value *ResponseGetLatestScanData
	isSet bool
}

func (v NullableResponseGetLatestScanData) Get() *ResponseGetLatestScanData {
	return v.value
}

func (v *NullableResponseGetLatestScanData) Set(val *ResponseGetLatestScanData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseGetLatestScanData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseGetLatestScanData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseGetLatestScanData(val *ResponseGetLatestScanData) *NullableResponseGetLatestScanData {
	return &NullableResponseGetLatestScanData{value: val, isSet: true}
}

func (v NullableResponseGetLatestScanData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseGetLatestScanData) UnmarshalJSON(src []byte) error {
	v.isSet = true
