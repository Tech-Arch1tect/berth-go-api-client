...
// checks if the ResponseAdminListServersData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseAdminListServersData{}

// ResponseAdminListServersData struct for ResponseAdminListServersData
type ResponseAdminListServersData struct {
	Data AdminListServersData `json:"data"`
	Error NullableError `json:"error,omitempty"`
	Meta NullableMeta `json:"meta,omitempty"`
	Success bool `json:"success"`
}

type _ResponseAdminListServersData ResponseAdminListServersData
...
func NewResponseAdminListServersData(data AdminListServersData, success bool) *ResponseAdminListServersData {
	this := ResponseAdminListServersData{}
	this.Data = data
...
func (o *ResponseAdminListServersData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseAdminListServersData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseAdminListServersData) MarshalJSON() ([]byte, error) {
...
func (o ResponseAdminListServersData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseAdminListServersData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseAdminListServersData := _ResponseAdminListServersData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseAdminListServersData)

	if err != nil {
		return err
	}

	*o = ResponseAdminListServersData(varResponseAdminListServersData)

	return err
}

type NullableResponseAdminListServersData struct {
	value *ResponseAdminListServersData
	isSet bool
}

func (v NullableResponseAdminListServersData) Get() *ResponseAdminListServersData {
	return v.value
}

func (v *NullableResponseAdminListServersData) Set(val *ResponseAdminListServersData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseAdminListServersData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseAdminListServersData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseAdminListServersData(val *ResponseAdminListServersData) *NullableResponseAdminListServersData {
	return &NullableResponseAdminListServersData{value: val, isSet: true}
}

func (v NullableResponseAdminListServersData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseAdminListServersData) UnmarshalJSON(src []byte) error {
	v.isSet = true
