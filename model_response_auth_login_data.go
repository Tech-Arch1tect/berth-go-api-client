...
// checks if the ResponseAuthLoginData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseAuthLoginData{}

// ResponseAuthLoginData struct for ResponseAuthLoginData
type ResponseAuthLoginData struct {
...
type _ResponseAuthLoginData ResponseAuthLoginData
...
func (o *ResponseAuthLoginData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseAuthLoginData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseAuthLoginData) MarshalJSON() ([]byte, error) {
...
func (o ResponseAuthLoginData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseAuthLoginData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseAuthLoginData := _ResponseAuthLoginData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseAuthLoginData)

	if err != nil {
		return err
	}

	*o = ResponseAuthLoginData(varResponseAuthLoginData)

	return err
}

type NullableResponseAuthLoginData struct {
	value *ResponseAuthLoginData
	isSet bool
}

func (v NullableResponseAuthLoginData) Get() *ResponseAuthLoginData {
	return v.value
}

func (v *NullableResponseAuthLoginData) Set(val *ResponseAuthLoginData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseAuthLoginData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseAuthLoginData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseAuthLoginData(val *ResponseAuthLoginData) *NullableResponseAuthLoginData {
	return &NullableResponseAuthLoginData{value: val, isSet: true}
}

func (v NullableResponseAuthLoginData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseAuthLoginData) UnmarshalJSON(src []byte) error {
	v.isSet = true
