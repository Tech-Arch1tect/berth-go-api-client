...
// checks if the ResponseListServersData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResponseListServersData{}

// ResponseListServersData struct for ResponseListServersData
type ResponseListServersData struct {
...
type _ResponseListServersData ResponseListServersData
...
func (o *ResponseListServersData) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *ResponseListServersData) SetMetaNil() {
	o.Meta.Set(nil)
}
...
func (o ResponseListServersData) MarshalJSON() ([]byte, error) {
...
func (o ResponseListServersData) ToMap() (map[string]interface{}, error) {
...
func (o *ResponseListServersData) UnmarshalJSON(data []byte) (err error) {
	...
	varResponseListServersData := _ResponseListServersData{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResponseListServersData)

	if err != nil {
		return err
	}

	*o = ResponseListServersData(varResponseListServersData)

	return err
}

type NullableResponseListServersData struct {
	value *ResponseListServersData
	isSet bool
}

func (v NullableResponseListServersData) Get() *ResponseListServersData {
	return v.value
}

func (v *NullableResponseListServersData) Set(val *ResponseListServersData) {
	v.value = val
	v.isSet = true
}

func (v NullableResponseListServersData) IsSet() bool {
	return v.isSet
}

func (v *NullableResponseListServersData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResponseListServersData(val *ResponseListServersData) *NullableResponseListServersData {
	return &NullableResponseListServersData{value: val, isSet: true}
}

func (v NullableResponseListServersData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResponseListServersData) UnmarshalJSON(src []byte) error {
	v.isSet = true
