...
type ApiApiV1ServersServeridGetRequest struct {
	ctx context.Context
	ApiService *ServersAPIService
	serverid int32
}

func (r ApiApiV1ServersServeridGetRequest) Execute() (*ResponseGetServerData, *http.Response, error) {
	return r.ApiService.ApiV1ServersServeridGetExecute(r)
}

/*
ApiV1ServersServeridGet Get server

Returns the server with the given id when the authenticated user has permission to access it

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param serverid Server ID
 @return ApiApiV1ServersServeridGetRequest
*/
func (a *ServersAPIService) ApiV1ServersServeridGet(ctx context.Context, serverid int32) ApiApiV1ServersServeridGetRequest {
	return ApiApiV1ServersServeridGetRequest{
		ApiService: a,
		ctx: ctx,
		serverid: serverid,
...
func (a *ServersAPIService) ApiV1ServersServeridGetExecute(r ApiApiV1ServersServeridGetRequest) (*ResponseGetServerData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ServersAPIService.ApiV1ServersServeridGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/servers/{serverid}"
